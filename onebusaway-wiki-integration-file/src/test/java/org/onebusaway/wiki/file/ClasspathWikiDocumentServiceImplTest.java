...
public class ClasspathWikiDocumentServiceImplTest {

  @Test
  public void test() throws WikiException {

    ClasspathWikiDocumentServiceImpl service = new ClasspathWikiDocumentServiceImpl();
    service.setPackageRoot("org/onebusaway/wiki/file");
